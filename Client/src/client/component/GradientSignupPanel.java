 ...
 * @author Sanskar
 */
public class GradientSignupPanel extends javax.swing.JPanel {

    public GradientSignupPanel() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color color1 = new Color(248, 215, 93);
        Color color2 = new Color(68, 112, 187);
